    ...
    <section className="py-10 2xl:py-20 3xl:py-[130px]">
      <Container>
        <div>
          ...
          <p
            className="max-w-[544px] text-text-gray text-lg lg:text-xl 2xl:text-2xl mt-6"
            data-aos="fade-up"
            data-aos-delay="200"
          >
          ...
          <div>
            <p
              className="mt-3 sm:mt-7 mb-5 md:mb-10 2xl:mt-12 text-sm md:text-base xl:text-lg 2xl:text-xl font-medium"
              data-aos="fade-up"
              data-aos-delay="300"
            >
            ...
            <hr className="py-3" />
            <h2 className="font-semibold mb-2 text-lg md:text-xl xl:text-2xl 2xl:text-3xl">
              What We Do
            </h2>
            <p className="font-medium mb-3 text-lg xl:text-xl">
              ParkClear helps drivers:
            </p>
            <ul className="list-disc list-inside font-medium space-y-3 xl:space-y-5 text-sm md:text-base xl:text-lg 2xl:text-xl">
            ...
            <p className="font-medium mt-5 mb-5 xl:mb-10 text-sm md:text-base xl:text-lg 2xl:text-xl">
              Whether you're a daily commuter, a new driver, or managing
              multiple vehicles, ParkClear is designed to simplify every aspect
              of ownership.
            </p>

            <h2 className="font-semibold text-lg md:text-xl xl:text-2xl mb-3 xl:mb-5">
              Built for Drivers
            </h2>
            <p className="font-medium text-sm md:text-base xl:text-lg 2xl:text-xl">
            ...
            <h2 className="font-semibold text-lg md:text-xl xl:text-2xl mb-3 xl:mb-5 mt-5 xl:mt-10">
              Join the Platform
            </h2>
            <p className="font-medium text-sm md:text-base xl:text-lg 2xl:text-xl">
