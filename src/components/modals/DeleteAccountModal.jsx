        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className={"dark:bg-gray-900"}>
                <div className="py-10 text-center">
                    ...
                    <h3 className="text-2xl pt-5 pb-4 font-bold text-dashboard-common-heading dark:text-white">Delete Account</h3>
                    <p className="text-sidebar-card-desc max-w-[350px] mx-auto mb-6 2xl:mb-10 dark:text-gray-200">Are you sure you want to delete your account</p>
