        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <div className="py-10 text-center">
                    ...
                    <h3 className="text-2xl pt-5 pb-4 font-bold text-dashboard-common-heading">Sorry</h3>
                    <p className="text-sidebar-card-desc max-w-[350px] mx-auto mb-10">Currently we are not accepting FIXED PENALT NOTICE</p>
                    <button
