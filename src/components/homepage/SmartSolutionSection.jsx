    ...
    <section className="py-[190px]">
      <Container>
        <div className="flex items-center">
          <div
            className="h-[700px] w-[40%] rounded-[16px] overflow-hidden"
            data-aos="fade-up"
            data-aos-delay="100"
          >
          ...
          <div className="w-[60%] pl-[166px]">
            ...
            <h3
              className="title--xxl leading-[110px]"
              data-aos="fade-up"
              data-aos-delay="100"
            >
            ...
            <p className="mt-6" data-aos="fade-up" data-aos-delay="200">
            ...
            <div data-aos="fade-up" data-aos-delay="300">
              <PrimaryButton
                ...
                className="text-white bg-theme-orange border-theme-orange hover:bg-transparent hover:text-theme-orange w-fit mt-12"
              />
            </div>
          </div>
        </div>
