...
const GenerateLetter = () => {
  return (
    <div>
      ...
      <div className="mt-5 border border-default-border p-5 3xl:p-7 4xl:p-10 rounded-lg bg-white dark:bg-black dark:border-border-gray max-w-[1550px] mx-auto">
        <p>
      ...
      <div className="flex justify-end gap-3 4xl:gap-5 items-center mt-10">
        <button className="font-medium text-lg px-4 py-2 4xl:py-3  border border-sidebar-card-headingOne bg-transparent rounded-lg text-sidebar-card-headingOne cursor-pointer transition-all duration-500 hover:bg-sidebar-card-headingOne hover:text-white">
          Submit this appeal through website
        </button>
        <button className="font-medium text-lg px-4 py-2 4xl:py-3 bg-sidebar-card-headingOne border border-sidebar-card-headingOne rounded-lg text-white cursor-pointer transition-all duration-500 hover:bg-transparent hover:text-sidebar-card-headingOne">
