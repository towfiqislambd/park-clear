...
import gogolePay from "../../../assets/images/images.jpg";
import applePay from "../../../assets/images/apple.webp";
    ...
    <div className="mb-5">
      ...
      <div className="grid xl:grid-cols-12 mt-5 xl:mt-10 max-w-[1550px] gap-5 xl:gap-0">
        ...
        <div className="xl:col-span-6">
          <p className="text-text-gray font-semibold text-base md:text-xl mb-1 md:mb-2">
            Secure and Transparent Transactions
          </p>
          <h3 className="font-bold text-3xl 3xl:text-5xl 4xl:text-6xl text-theme-orange mb-2 md:mb-4 3xl:mb-7">
            Payment
          </h3>
          <p className="md:font-medium text-sm md:text-base text-text-gray leading-[24px] mb-7 md:mb-10 xl:mb-22">
            ...
            guarantee a smooth and trustworthy payment experience for our users.
          </p>
          <img
            src={payment}
            alt=""
            className="ml-10 md:ml-20 w-[230px] md:w-[350px]"
          />
        </div>
        ...
        <div className="xl:col-span-5">
          ...
          <div className="p-3 md:p-5 3xl:p-10 mb-4 md:mb-5 xl:mb-10 3xl:mb-20 rounded-lg border border-default-border bg-white dark:bg-transparent">
            <h3 className="text-lg md:text-[22px] mb-1 md:mb-2 font-semibold text-dashboard-common-heading dark:text-white">
              Total amount
            </h3>
            <h2 className="font-bold text-theme-orange text-2xl md:text-3xl 3xl:text-4xl">
              £3.99
            </h2>
          </div>
          <h2 className="text-dashboard-common-heading dark:text-white font-bold text-lg md:text-2xl 3xl:text-3xl 4xl:text-4xl mb-3 md:mb-5 4xl:mb-7">
            Payment Method
          </h2>
          ...
          <div className="space-y-5 mb-7">
            <button className="h-[50px] 4xl:h-[70px] border border-default-border font-semibold md:text-lg w-full block rounded-lg cursor-pointer flex gap-2 justify-center items-center">
              <img src={applePay} alt="gogolePay" className="w-16 " />
              <span className="dark:text-white">Apple Pay</span>
            </button>
            <button className="h-[50px] 4xl:h-[70px] border border-default-border font-semibold md:text-lg w-full block rounded-lg cursor-pointer flex gap-2 justify-center items-center">
              <img src={gogolePay} alt="gogolePay" className="w-14 " />
              <span className="dark:text-white">Google Pay</span>
            </button>
            <button className="h-[50px] 4xl:h-[70px] border border-default-border font-semibold md:text-lg w-full block rounded-lg cursor-pointer flex gap-2 justify-center items-center">
              <StripeSvg />
          ...
          <p className="text-sm md:text-base dark:text-white">
            By proceeding, you acknowledge and automatically agree to our Terms
