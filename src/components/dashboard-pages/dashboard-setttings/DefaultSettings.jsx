    ...
    <section>
      ...
      <div className="flex justify-between items-end px-5 py-4 mt-5 mb-10 rounded-xl bg-white dark:bg-black border border-default-border dark:border-border-gray">
        ...
        <div className="flex gap-5">
          ...
          <div className="">
            <h3 className="font-medium text-dashboard-common-heading dark:text-white text-2xl mb-3">
              Musfiq
            </h3>
            <p className="ext-dashboard-common-heading mb-1">
              Mail: email@mail.com
            </p>
            <p className="ext-dashboard-common-heading mb-7">
              Phone:+923787248724872
            </p>
            <button
              onClick={() => setEditProfile(true)}
              className="border border-theme-orange rounded-[6px] cursor-pointer hover:bg-theme-orange hover:text-white duration-300 transition-all py-3 px-5 text-theme-orange font-medium"
            >
              Edit Profile
            </button>
          </div>
        ...
        {/* Right */}
        <button className="px-10 py-3 rounded-[6px] text-white cursor-pointer bg-theme-orange">
          Instalment
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-5">
        {/* Appearance */}
        <div>
          <h3 className="text-2xl mb-5 text-dashboard-common-heading dark:text-white font-medium">
            Appearance
          </h3>
      ...
      <div className="grid grid-cols-2 gap-5 mt-7">
        ...
        <div>
          ...
          <div
            ...
            className="flex justify-between items-center border cursor-pointer rounded p-7 rounded-lg border-default-border dark:border-border-gray bg-white dark:bg-black"
          >
        ...
        {/* Notification  */}
        <div>
          <h3 className="text-2xl mb-5 text-dashboard-common-heading font-medium dark:text-white">
            Notification{" "}
          </h3>
          <div className="flex justify-between items-center border rounded p-7 rounded-lg border-default-border dark:border-border-gray bg-white dark:bg-black">
            <div className="flex gap-3 items-center">
              <NotificationSvg />
              <span className="text-dashboard-common-heading dark:text-white">
