        ...
        <div>
            ...
            <ResponsiveContainer width="100%" height={370}>
                <LineChart data={data}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Line type="monotone" dataKey="uv" stroke="#77B5FE" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
                    <Line type="monotone" dataKey="pv" stroke="#ffb1c1" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
                </LineChart>
            </ResponsiveContainer>
        </div>
    );
