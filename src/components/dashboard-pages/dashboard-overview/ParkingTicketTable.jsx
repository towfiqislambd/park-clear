...
const ParkingTicketTable = () => {
    ...
    return (
        <div className="mt-5 mb-10">
            {/* Title */}
            <h3 className="mb-5 text-dashboard-common-heading text-xl font-semibold"> Parking Ticket Dashboard</h3>

            <table className="w-full text-center text-dashboard-common-heading">
                <thead className="bg-white rounded-lg text-dashboard-common-heading font-semibold">
                    <tr>
            ...
            <div className="flex items-center justify-between mt-5">
                ...
                <div className="flex items-center gap-5 text-sm">
                    <span className="text-gray-desc">Rows per page:</span>
                    <select className="border text-gray-500 border-default-border outline-none px-2 py-1 rounded">
                        <option>05</option>
                        <option>10</option>
                        <option>15</option>
                    </select>
                    <span className="text-gray-desc">1-4 of 4</span>
                    <div className="flex gap-1">
                        <button className="border px-2 py-1 border-default-border text-gray-400 rounded">&lt;</button>
                        <button className="border px-2 py-1 border-default-border text-gray-400 rounded">1</button>
                        <button className="border px-2 py-1 border-default-border text-gray-400 rounded">&gt;</button>
                    </div>
                </div>
            </div>
