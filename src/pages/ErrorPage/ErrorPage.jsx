...
const ErrorPage = () => {
    ...
    return (
        <section className="container text-center flex items-center justify-center flex-col gap-5 h-screen">
            ...
            <Link
                to="/"
                className="px-4 sm:px-6 py-1 sm:py-2 duration-300 hover:bg-transparent hover:text-primaryBgColor border-2 border-primaryBgColor bg-primaryBgColor text-white font-medium rounded"
            >
                Go Back Home
            </Link>
        </section>
