...
import { DarkModeSvg, DesktopSvg, LightModeSvg } from "@/components/svg-container/SvgContainer";
            ...
            <div className="flex justify-between items-end px-5 py-4 mt-5 mb-10 rounded-xl bg-white border border-default-border">
                ...
                <div className="flex gap-5">
                    ...
                    <div className="">
                        ...
                        <button className="border border-theme-orange rounded-[6px] cursor-pointer hover:bg-theme-orange hover:text-white duration-300 transition-all py-3 px-5 text-theme-orange font-medium">Edit Profile</button>
                    </div>
                </div>
                {/* Right */}
